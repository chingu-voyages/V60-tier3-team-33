...
interface TrendChartProps {
    data: { label: string; total: number; interviewed: number }[];
    timeframe: 'thisMonth' | 'allTime';
}

export const WeeklyApplicationsChart = ({ data, timeframe }: TrendChartProps) => {
    const title = timeframe === 'thisMonth' ? 'Applications Trend (This Month)' : 'Applications Trend (All Time)';
