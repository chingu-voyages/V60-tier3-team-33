...
const AccountCreationPage: React.FC = () => {
  ...
  const onSubmit = (data: AccountCreationFormInputs) => {
        ...
        <div className="w-full md:w-1/3 flex items-center justify-center p-8 md:p-6 lg:p-10 xl:p-12 md:bg-white h-full relative z-10 md:shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          <div className="w-full max-w-md md:max-w-[280px] lg:max-w-[300px] xl:max-w-[320px] mx-auto flex flex-col justify-center h-full">
            ...
            >
              ...
              <button
                type="submit"
                className="submit-button bg-black text-white text-[16px] md:text-[13px] lg:text-sm font-medium rounded-[100px] h-[52px] md:h-[44px] lg:h-[48px] w-full hover:bg-gray-800 transition-colors md:mt-2"
              >
                Create Account
              </button>
            </form>
            <div className="flex flex-col items-center mt-[69px] md:mt-8 lg:mt-10 text-[#BDBDBD] gap-2 md:gap-1.5">
              ...
              <a href="#" className="text-[22px] md:text-[13px] lg:text-sm underline text-black font-medium">
                Login
              </a>
            </div>
          </div>
